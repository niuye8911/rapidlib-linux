...
class appMethods(AppMethods):
    ...
    def computeQoSWeight(self, preferences, values):
        ...
        normalization = (precision_pref + recall_pref)/precision_pref*recall_pref
        return 100.0*precision_pref*presicion * recall_pref*recall / (precision*precision_pref+recall_pref*recall)
    ...
    def getQoS(self):
        ...
        for line in result:
            ...
            break
        return [precision, recall, 100.0*precision*recall/(precision+recall)]
