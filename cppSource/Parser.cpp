...
#define FOR_EACH_SVC_NODE(root_node)                                           \
  for (xml_node<> *svc_node = root_node->first_node("service"); svc_node;      \
       svc_node = svc_node->next_sibling("service"))

#define FOR_EACH_LEVEL_NODE(svc_node)                                          \
  for (xml_node<> *level_node = svc_node->first_node("servicelayer");          \
       level_node; level_node = level_node->next_sibling("servicelayer"))
